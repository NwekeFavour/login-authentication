        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-6 my-5'>
                    <div class='Logo'>
                        <p class='h4 fw-bold  m-0'>LOGO</p>
                    </div>
                    <div class='art mt-5'>
                        <p class='m-0'>Artificial Intelligence Driving
                        Results For The Travel Industry</p>
                    </div>
                    <div>
                   ...
                   <form @submit.prevent="createPost">
                        <div class='form-floating mb-3'>
                            <input type="text" name="name" class="form-control shadow-none" id="name" v-model="formData.name" placeholder="name">
                ...
                <div class='col-md-6 navi d-none d-md-block my-5'>
                    ...
                    <div class='Clip'>
                        <img src="./assets/clip-message-sent 1.svg"/>
                    </div>
                </div>
            </div>
        </div>
